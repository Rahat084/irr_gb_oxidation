 ...
 */
class GrainBoundaryDrift : public Kernel
{
public:
  /**
   ...
   */
  GrainBoundaryDrift(const InputParameters & parameters);
...
private:
  ...
  const Real _k;
  const Real _T;
  const VariableValue& _gbNormalStress;
  const VariableGradient& _gbNormalStressGradient;
};
